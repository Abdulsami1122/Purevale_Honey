...
const FAQ_SECTIONS = [
  ...
  {
    category: 'NUSKHA E QALB & EZ SLIM',
    subtitle: 'Frequently ask questions',
    items: [
      {
        id: 'nuskha-1',
        question: 'Can a lactating mother use it or not?',
        answer: 'Lactating mothers should avoid aggressive detox/slimming formulas and only use gentle pure honeys under healthcare guidance.',
      },
      {
        id: 'nuskha-2',
        question: 'Is it suitable for use while trying to conceive?',
        answer: 'Natural herbal tonics are generally supportive, but specialized detox formulations should be discontinued during active conception cycles.',
      },
      {
        id: 'nuskha-3',
        question: 'Can it be used during pregnancy?',
        answer: 'No, pregnant women should avoid warming detox formulas (like EZ Slim) and stick to pure raw Sidr honey or Ajwa dates.',
      },
      {
        id: 'nuskha-4',
        question: 'Thyroid patient can use it or not?',
        answer: 'Yes, the natural active ingredients help stimulate healthy metabolic activity without synthetic hormones.',
      },
      {
        id: 'nuskha-5',
        question: 'Can it be used during PCOS?',
        answer: 'Yes, it assists in insulin sensitivity and metabolic regulation, which are key for managing PCOS symptoms.',
      },
      {
        id: 'nuskha-6',
        question: 'If a patient undergoing dialysis can use it?',
        answer: 'Dialysis patients must consult their treating physician prior to taking any concentrated herbal blends.',
      },
      {
        id: 'nuskha-7',
        question: 'Can a patient with heart valve leakage use it?',
        answer: 'Nuskha-e-Qalb is a natural cardiovascular herbal blend, but patients with structural heart conditions should consult their cardiologist.',
      },
      {
        id: 'nuskha-8',
        question: 'Why nuskha e qalb sugar free is costly?',
        answer: 'The sugar-free edition uses cold-pressed apple cider vinegar, organic garlic, ginger, and natural stevia/monk fruit extracts without cheap glucose fillers.',
      },
      {
        id: 'nuskha-9',
        question: 'Swollen liver patient can use it?',
        answer: 'Its potent anti-inflammatory botanicals aid liver decongestion and fatty liver recovery when taken consistently in mild doses.',
      },
      {
        id: 'nuskha-10',
        question: 'Swollen stomach patient can use it?',
        answer: 'Yes, it promotes gastric motility and relieves abdominal bloating and acid reflux.',
      },
      {
        id: 'nuskha-11',
        question: 'Can it be used by a patient with pacemaker?',
        answer: 'Yes, as it is a dietary herbal tonic with no electromagnetic or cardiac interference.',
      },
      {
        id: 'nuskha-12',
        question: 'Does regular use of these two products cause kidney damage?',
        answer: 'No, all ingredients are 100% natural foods (garlic, ginger, lemon, organic ACV) with zero chemical toxicity.',
      },
    ],
  },
]
