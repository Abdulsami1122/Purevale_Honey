    ...
    <div className="page-container">
      ...
      <div className="page-content-wrapper">
        <div className="info-section-card">
          ...
          <p>
            At Purevale, we take great pride in our carefully packed glass jars and vacuum-sealed products. If your parcel arrives damaged, leaking, broken in transit, or if you receive an incorrect product, you are eligible for an immediate replacement or full refund within <strong>7 days</strong> of delivery.
          </p>

          <h2>2. 100% Purity & Lab Test Guarantee</h2>
          <p>
            We stand unreservedly behind the authentic purity of our raw honey and natural products. If you test our honey in any accredited government laboratory and find artificial adulteration (such as corn syrup, invert sugar, or chemical additives), Purevale will issue a <strong>100% full refund</strong> including reimbursement for your testing fees.
          </p>
          ...
          <ul className="info-list-styled">
            ...
            <li>
              <strong>Step 2:</strong> Send the details via WhatsApp to <strong>0333 9300672</strong> or email <strong>support@purevale.com</strong>.
            </li>
            <li>
